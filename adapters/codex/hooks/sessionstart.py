#!/usr/bin/env python3
"""Codex SessionStart hook for jev-compact.

After Codex compacts (source == "compact"), injects the jev-compact
retention output as additionalContext so the compacted session resumes
with verbatim load-bearing spans + tombstone receipts on top of the
native summary.
